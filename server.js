...
// Provide user with initiation message for employee manager
console.table(
...
// Provide user with list of options to select to initiate the prompts
...
// Variable to show all employees
...
// Variable to show all departments
...
// Provide user with prompt to add new employees
...
// Provide user with prompt to add a new department
...
// Provide user with prompt to add a new role
const roleAdd = async () => {
    try {
...
// Provide user with prompt to update an employees data
